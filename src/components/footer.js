        ...
        <div class="wrapper">
          <div class="text-block">
                      ...
                      <div class="loop-icons">
                            <div class="icon">
                                <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512" class="svg-inline--fa fa-heart fa-w-16 fa-2x">
                        ...
                        {/*<div class="icon">*/}
                        {/*    <svg aria-hidden="true"role="img" xmlns="http://www.w3.org/2000/svg"*/}
                        {/*         viewBox="0 0 640 512" class="svg-inline--fa fa-coffee fa-w-20 fa-2x">*/}
            ...
            <div class="row">
              ...
              <span> <a href="/" aria-label="Home | MayankRaj.com"> Home </a> </span>
              <span> <a href="/blog" aria-label="Blog | MayankRaj.com"> Blog </a> </span>
              <span> <a href="https://github.com/rajmayank/mayankraj.com" aria-label="Source | MayankRaj.com"> Source </a> </span>
              <span>
                        <a href="/blog/feed.xml" class="icon" aria-label="RSS Feed">
                            <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 448 512" class="svg-inline--fa fa-rss fa-w-14 fa-2x">
                                <path fill="currentColor"
          ...
          <div class="icons-block">
            <div class="row">
              <a href="https://twitter.com/Mayank9856" class="icon" aria-label="Twitter">
              ...
              <a href="https://www.linkedin.com/in/mayank9856/" class="icon" aria-label="LinkedIn">
              ...
              <a href="https://www.facebook.com/mayank9856" class="icon" aria-label="Facebook">
                <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="https://github.com/rajmayank" class="icon" aria-label="GitHub">
                <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 448 512" class="svg-icon">
                  <path fill="currentColor"
              ...
              <a href="mailto:hello@mayankraj.com" class="icon" aria-label="Email">
                <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                     class="svg-icon">
                  <path fill="currentColor"
