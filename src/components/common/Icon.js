...
const icons = {
  ...
  tag: (
    ...
    >
      <path
        fill="currentColor"
        d="M0 80V229.5c0 17 6.7 33.3 18.7 45.3l176 176c25 25 65.5 25 90.5 0L418.7 317.3c25-25 25-65.5 0-90.5L214.6 41.4c-12-12-28.3-18.7-45.3-18.7H48C21.5 22.7 0 44.2 0 70.5V80zm48 0V70.5c0-1.4 1.1-2.5 2.5-2.5H169.4c4.2 0 8.3 1.7 11.3 4.7L372.7 256.7c4.2 4.2 4.2 11 0 15.2L180.7 443.3c-4.2 4.2-11 4.2-15.2 0L48 229.5V80zm64 96c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"
      ></path>
    </svg>
  ),
  external: (
