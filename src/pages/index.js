      ...
      <div className="content-container">
        <div className="name-container">
          <div className="name-block">
            <svg viewBox="0 0 140 80" xmlns='http://www.w3.org/2000/svg' version='1.1'>
              ...
              <text text-anchor="start" x="10" y="70" className="text text-stroke text-stroke-2"
                    clip-path="url(#text2)">
                Raj
              </text>
              <defs>
        ...
        <div className="description-container">
          ...
          <div className="badges">
            ...
            <OutboundLink href="https://www.credly.com/badges/3b0f1aaa-7afd-4fb5-bb83-a1601f642bb2/public_url"
            ...
            <OutboundLink href="https://www.credly.com/badges/8a486510-a537-48f1-a29e-2643aa626be0/public_url"
                          target="_blank" rel="noreferrer">
              <img src={ImgBadgeSAP}
                   alt="AWS Certified Solutions Architect – Professional"
