      ...
      <div className="content-container">
        <div className="text text-justify text-spacers">
          ...
          <div className="section-top-margin --tight">
            ...
            <p>
              By day, I'm a Lead Engineer at Salesforce, where I wear the cape
              of a digital locksmith. My mission? To fortify the Salesforce
              ecosystem with unbreakable cryptography. It's like being a secret
              agent, but instead of shaken martinis, I deal with stirred
              algorithms.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                As the founder of Apptale.io, I created a monitoring service
                that keeps an eagle eye on systems across all 51 AWS
                availability zones. It's like having a digital guardian angel
                for your apps, but at 1/15th the cost of its competitors.
              </li>
              <li>
            ...
            <p>
              ...
              of technology together, or if you just want to chat about the best
              trekking routes or the future of serverless architecture, drop me
              a line!
            </p>
            <p>
