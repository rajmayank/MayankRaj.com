    ...
    <ContentContainer as="main" className="content-body text-justify">
      ...
      <section className="mt-16 font-primary text-[1.9rem] font-normal leading-[1.6]">
        <p>
          ...
          trekker who builds AI systems, and a drone enthusiast who secures the
          digital world. That's me in a nutshell, but let's dive a bit deeper,
          shall we?
        </p>
        <p>
          ...
          fortify the Salesforce ecosystem with unbreakable cryptography. It's
          like being a secret agent, but instead of shaken martinis, I deal
          with stirred algorithms.
        </p>
        <p>
          But my journey hasn't always been about digital fortresses. I've worn
          many hats in my tech odyssey:
        </p>
        <ul>
          <li>
            At{" "}
            ...
            , I was the ringmaster of a 15+ engineer circus, juggling big data
            and machine learning acts. We built a data platform that could
            swallow 1.5TB of data per week and spit out insights faster than
            you can say "algorithm."
          </li>
          <li>
            As the founder of{" "}
            <OutboundLink href="https://Apptale.io/">Apptale.io</OutboundLink>,
            I created a monitoring service that keeps an eagle eye on systems
            across all 51 AWS availability zones. It's like having a digital
            guardian angel for your apps, but at 1/15th the cost of its
            competitors.
          </li>
          <li>
        ...
        <p>
          When I'm not immersed in the digital realm, you might find me scaling
          mountains, coaxing melodies from my violin, or tinkering with drones.
          I believe in the power of diverse experiences to fuel creativity and
          innovation in tech.
        </p>
        ...
        <Accordion id="IndexAccordianReadMore">
          <AccordionDetails id="IndexAccordianReadMoreDetails">
            <p>
              ...
              perfect harmony. And sometimes, it's about knowing when to
              improvise a killer solo.
            </p>
            <p>
              I'm passionate about bridging the gap between complex technology
              and real-world applications. Whether it's designing systems that
              process terabytes of data or crafting APIs that handle thousands
              of requests with sub-second latency, I love making tech work
              smarter, not harder.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                time of just 8 minutes. It's like finding a needle in a
                haystack, if the haystack were the size of Texas and the needle
                were invisible.
              </li>
              <li>
                ...
                unique users across 4 conferences. It's my way of giving back
                to the tech community that's given me so much.
              </li>
            </ul>
            <p className="hidden">
              Currently, I'm on the lookout for senior technology leadership
              roles and speaking opportunities at conferences. I'm particularly
            ...
            <p>
              If you're interested in discussing how we can push the boundaries
              of technology together, or if you just want to chat about the
              best trekking routes or the future of serverless architecture,
              drop me a line!
            </p>
          </AccordionDetails>
          <AccordionSummary
